...
def weather_banner():
    return f'<section class="weather-banner"><img src="{WEATHER_FILE}" alt="{WEATHER_ALT}"></section>'
...
def main():
    ...
    print(f"Law & Order start={LAW_AND_ORDER_START} ; Not A Trans start={NOT_A_TRANS_START}")
